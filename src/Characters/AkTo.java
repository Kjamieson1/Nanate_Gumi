...
public class AkTo extends Thread implements GameCharacter
{
    ...
    public void run()
    {
        ...
        System.out.println("========== Akashi Takenori =========== \n"
                + "Born in the 1560's Edo period Japan in the Harima Province, Akashi Takenori was known for his fierce warrior spirit and unmatched combat skills. \n"
            ...
            while(enemy.health() > 0 && hp > 0)
            {
                System.out.println("_____________________________ \n"
                    ...
                    case 1:
                        ...
                        enemy.hp -= AkToDam;
                        System.out.println("_____________________________ \n"
                                + "You dealt " + AkToDam + " damage to the enemy! \n"
        ...
        System.out.println("========== Akashi Takenori =========== \n"
                + "Heading back to camp, there is no sign of Okita Nobunaga. \n"
        ...
        switch(sc.nextInt())
        {
            case 1:
                System.out.println("========== Akashi Takenori =========== \n"
                        + name + " has accepted the position under Toyoyomi Hideyoshi. \n"
                        + "He fights bravely in many battles and earns a reputation as one of Hideyoshi's most trusted samurai. \n");
                break;
            case 2:
                System.out.println("========== Akashi Takenori =========== \n"
                        + name + " has declined the position and chooses to remain a ronin. \n"
        ...
        try{
            for (int i = 1; i <= x; i++)
            {
                switch (i) 
                {
                    case 1:
                        System.out.println("_____________________________ \n"
                                + name + " jumps into the air swinging the katana \n");
        ...
        try{
            for (int i = 1; i <= x; i++)
            {
                switch (i) 
                {
                    case 1:
                        System.out.println("_____________________________ \n"
                                + name + " looks his opponent in the eye \n");
                        Thread.sleep(ra.nextInt(1000) + 500);
                        break;
                    case 2:
